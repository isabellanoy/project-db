...
DROP FUNCTION IF EXISTS fn_pago_cuota_tarjeta;
DROP FUNCTION IF EXISTS fn_pago_cheque;
DROP FUNCTION IF EXISTS fn_pago_cuota_cheque;
DROP FUNCTION IF EXISTS fn_pago_deposito;
DROP FUNCTION IF EXISTS fn_pago_cuota_deposito;
DROP FUNCTION IF EXISTS fn_pago_operacion_digital;
DROP FUNCTION IF EXISTS fn_pago_cuota_operacion_digital;
DROP FUNCTION IF EXISTS fn_pago_cripto;
DROP FUNCTION IF EXISTS fn_pago_cuota_cripto;
...
DROP FUNCTION IF EXISTS fn_pago_cuota_millas;
...
DROP PROCEDURE IF EXISTS sp_validar_pagos_cuota;
